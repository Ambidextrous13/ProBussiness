	...
	<section class="wrapper">
        ...
        <div class="row sub_content">
            ...
            <div class="col-lg-6">
                ...
                <br/>
                <a href="https://www.yahoobaba.net/lab/tabs/" class="btn btn-default">More Tab Style</a>
            </div>

            <div class="col-lg-6 vertical-tab">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#Popular1" data-toggle="tab">Popular</a></li>
                    <li class=""><a href="#Recent1" data-toggle="tab">Recent</a></li>
                    <li class=""><a href="#Comment1" data-toggle="tab">Comment</a></li>
                </ul>
        ...
        <div class="row sub_content">
            ...
            <div class="col-lg-6 col-sm-6 ">
                        ...
                        <div class="panel-heading" role="tab" id="headingThree">
                            <h4 class="panel-title">
                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                    <span class="left-icon"><i class="fa fa-mobile"></i></span>
                ...
                <br/>
                <a href="https://www.yahoobaba.net/lab/accordion/" class="btn btn-default">More Accordion Style</a>
            </div>
        ...
        <div class="row sub_content">
            ...
            <div class="col-lg-6 ">
                ...
                <br/>
                <a href="https://www.yahoobaba.net/lab/progress-bar/" class="btn btn-default">More Progress Bar Style</a>
            </div> <!--./ col-lg-6  -->
